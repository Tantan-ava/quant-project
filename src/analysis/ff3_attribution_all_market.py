...
def main():
    ...
    print(f"""
我们的月度组合策略(价值40%+反转60%，全市场股票池)在2006-2025年期间（标准FF3归因）：
...
""")
    ...
    results_df.to_csv(f'{output_dir}/ff3_attribution_all_market.csv', index=False)
    print(f"\n结果已保存: {output_dir}/ff3_attribution_all_market.csv")
